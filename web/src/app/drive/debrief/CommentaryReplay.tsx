...
const severityConfig = {
  1: { bg: 'bg-zinc-700', text: 'text-zinc-300', label: 'Info' },
  ...
  return (
    <div className="rounded-lg bg-zinc-800 border border-zinc-700 p-6">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-semibold text-zinc-100">Commentary Replay</h2>
      </div>
      ...
      <div className="space-y-3">
        {sortedEntries.map((entry, idx) => {
          ...
          return (
            <div
              key={idx}
              className="flex gap-3 pb-3 border-b border-zinc-700 last:border-0"
            >
              {/* Left: Lap marker */}
