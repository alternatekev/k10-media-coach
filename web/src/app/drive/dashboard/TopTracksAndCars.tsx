...
/* ── Tracks list (exported separately) ─────────────────────────── */
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="text-xs font-normal text-[var(--text-secondary)] flex-1" style={{ fontFamily: 'var(--ff-display)' }}>
                    {displayName}
                  </span>
                  <span
    ...
    <div className="flex flex-col gap-4">
      {tracks.length > 0 && (
        <div>
          ...
          <TopTracks tracks={tracks} trackMapLookup={trackMapLookup} trackDisplayNameLookup={trackDisplayNameLookup} />
        </div>
      )}
      {cars.length > 0 && (
        <div>
          ...
          <TopCars cars={cars} brandLogoLookup={brandLogoLookup} />
        </div>
      )}
    </div>
  )
