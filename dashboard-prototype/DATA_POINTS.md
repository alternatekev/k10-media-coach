...
All properties below are confirmed available through SimHub's DataCorePlugin, the Media Coach plugin's AttachDelegate properties, or iRacing Extra Properties plugin.

## Media Coach Plugin Properties (Custom)
| Property | Type | Source |
|---|---|---|
| `MediaCoach.Plugin.CommentaryText` | string | Full commentary prompt |
| `MediaCoach.Plugin.CommentaryVisible` | int (0/1) | Show/hide banner |
| `MediaCoach.Plugin.CommentaryTopicTitle` | string | Event name ("Close Battle") |
| `MediaCoach.Plugin.CommentaryCategory` | string | Category + sentiment label |
| `MediaCoach.Plugin.CommentarySentimentColor` | string | #AARRGGBB overlay color |
| `MediaCoach.Plugin.CommentaryTextColor` | string | #AARRGGBB text color |
| `MediaCoach.Plugin.CommentarySeverity` | int (0-5) | Severity level |
| `MediaCoach.Plugin.CurrentFlagState` | string | "green", "yellow", "red", etc. |
| `MediaCoach.Plugin.NearestCarDistance` | double (0-1) | Proximity fraction |
