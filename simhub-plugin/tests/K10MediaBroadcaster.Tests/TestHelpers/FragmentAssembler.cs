...
namespace K10MediaBroadcaster.Tests.TestHelpers
{
    /// <summary>
    ...
    public class FragmentAssembler
    {
        ...
        public void LoadFragmentsFromJson(string json)
        {
            ...
            {
                Console.WriteLine("[K10MediaBroadcaster.FragmentAssembler] Empty JSON provided");
                return;
            }
            ...
            try
            {
                ...
                Console.WriteLine($"[K10MediaBroadcaster.FragmentAssembler] Loaded {_fragments.Count} fragment topics");
            }
            catch (Exception ex)
            {
                Console.Error.WriteLine($"[K10MediaBroadcaster.FragmentAssembler] Failed to load fragments: {ex.Message}");
            }
        }
