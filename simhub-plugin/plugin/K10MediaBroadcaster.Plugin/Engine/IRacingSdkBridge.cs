// ═══════════════════════════════════════════════════════════════
// K10 Media Broadcaster — iRacing SDK Bridge
//
...
namespace K10MediaBroadcaster.Plugin.Engine
{
    ...
    public sealed class IRacingSdkBridge : IDisposable
    {
        ...
        public void Start()
        {
            ...
            SimHub.Logging.Current.Info("[K10MediaBroadcaster] IRacingSdkBridge started");
        }
        ...
        public void Stop()
        {
            ...
            {
                SimHub.Logging.Current.Error("[K10MediaBroadcaster] Error stopping SDK: " + ex.Message);
            }

            IsStarted = false;
            IsConnected = false;

            SimHub.Logging.Current.Info("[K10MediaBroadcaster] IRacingSdkBridge stopped");
        }
        ...
        {
            IsConnected = true;
            SimHub.Logging.Current.Info("[K10MediaBroadcaster] iRacing SDK connected");
        }

        private void OnDisconnected()
        {
            IsConnected = false;
            SimHub.Logging.Current.Info("[K10MediaBroadcaster] iRacing SDK disconnected");
        }
        ...
        private void OnSessionInfo()
        {
            ...
            {
                SimHub.Logging.Current.Error("[K10MediaBroadcaster] Error parsing session info: " + ex.Message);
            }
        }
